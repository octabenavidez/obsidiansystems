...
const TimelineRoadmap = () => {
  ...
  const timelineSteps = [
    ...
    },
    {
      title: "Estrategia",
      subtitle:
        "Creamos tu Adquisición / Conversación y tu oferta adaptada a lo que mejor te funciona.",
      description:
      ...
      <div className="relative pt-32 pb-20">
        ...
        <div className="space-y-0">
          {timelineSteps.map((step, index) => {
            const visibility = stepVisibility[index] || 0;
                ...
                {step.side === "center" ? (
                  ...
                  <div className="relative pl-16 md:pl-0">
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-16">
                      {/* Left Side */}
                      <div
                        className={`${step.side === "left" ? "md:order-1" : "md:order-2"}`}
                      >
                        {step.side === "left" && (
                          <div className="space-y-4 md:pr-16 md:text-right">
                            {/* Title Box */}
                            <div
                      ...
                      {/* Right Side */}
                      <div
                        className={`${step.side === "right" ? "md:order-2" : "md:order-1"}`}
                      >
                        {step.side === "right" && (
                          <div className="space-y-4 md:pl-16 md:text-left">
                            {/* Title Box */}
                            <div
                              className={`relative overflow-hidden rounded-xl border bg-black p-6 transition-all duration-500 ${
                                isActive
